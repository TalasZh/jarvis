...
*/((function() {
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = [].slice, G = {}.hasOwnProperty, H = function(a, b) {
        function d() {
            this.constructor = a
        }
        for (var c in b)
    ...
    r = function(b) {
        ...
        return c = this.map(function() {
            var c, d, e, f;
            e = "", c = this;
            while ((c != null ? c.nodeType : void 0) === Node.ELEMENT_NODE && c !== b)
                f = c.tagName.replace(":", "\\:"), d = a(c.parentNode).children(f).index(c) + 1, d = "[" + d + "]", e = "/" + c.tagName.toLowerCase() + d + e, c = c.parentNode;
            return e
        }), c.get()
    }, s = function(a) {
        var b, c, d, e;
        return b = function(a) {
            ...
            while (a !== e) {
                if (a == null)
                    throw new Error("Called getPathTo on a node which was not a descendant of @rootNode. " + e);
        ...
        b = 0, c = a;
        while (c)
            c.nodeName === a.nodeName && b++, c = c.previousSibling;
        return b
    }, p = null, typeof Gettext != "undefined" && Gettext !== null ? (u = new Gettext({domain: "annotator"}), p = function(a) {
        return u.gettext(a)
    }) : p = function(a) {
        return a
    }, E = function(a) {
        ...
        return c = function(b) {
            ...
            for (f = 0, g = b.length; f < g; f++)
                d = b[f], e = e.concat(d && a.isArray(d) ? c(d) : d);
            return e
        }, c(b)
        ...
        return b = function(a) {
            ...
            if (a && a.nodeType !== Node.TEXT_NODE) {
                ...
                if (a.nodeType !== Node.COMMENT_NODE) {
                    a = a.lastChild;
                    while (a)
                        c.push(b(a)), a = a.previousSibling
                }
                return c.reverse()
            }
            return a
        ...
        for (h = 0, i = g.length; h < i; h++)
            f = g[h], k = f.split("["), d = k[0], c = k[1], c = c != null ? parseInt((c != null ? c.split("]") : void 0)[0]) : 1, e = j(e, d.toLowerCase(), c);
        return e
    }, f.escape = function(a) {
        ...
        return c = function() {
            ...
            for (c = 0, e = b.length; c < e; c++)
                d = b[c], a(d).css("position") === "static" ? f.push(-1) : f.push(parseInt(a(d).css("z-index"), 10) || -1);
            return f
        }(), Math.max.apply(Math, c)
    }, f.mousePosition = function(b, c) {
        var d;
        return d = a(c).position(), {top: b.pageY - d.top,left: b.pageX - d.left}
    ...
    if (typeof console != "undefined" && console !== null) {
        ...
        for (v = 0, x = l.length; v < x; v++)
            k = l[v], console[k] == null && (console[k] = function() {
                return console.log(E("Not implemented:") + (" console." + name))
            })
    } else {
        this.console = {};
        for (w = 0, y = l.length; w < y; w++)
            k = l[w], this.console[k] = function() {
            };
    ...
    c = function() {
        ...
        return b.prototype.events = {}, b.prototype.options = {}, b.prototype.element = null, b.prototype.addEvents = function() {
            ...
            f = this.events, h = [];
            for (c in f)
                b = f[c], g = c.split(" "), d = 2 <= g.length ? F.call(g, 0, e = g.length - 1) : (e = 0, []), a = g[e++], h.push(this.addEvent(d.join(" "), a, b));
            return h
        ...
        return c == null && (c = document), e = function(a, b) {
            ...
            for (a = 0, c = d.length; a < c; a++)
                i = d[a], i && i.indexOf(":") === -1 ? e.push(i.replace(/^([a-z]+)/, "xhtml:$1")) : e.push(i);
            return e
        ...
        return a.prototype.normalize = function(a) {
            ...
            if (this.tainted)
                return console.error(E("You may only call normalize() once on a BrowserRange!")), !1;
            ...
            for (i = 0, j = k.length; i < j; i++) {
                ...
                if (c.nodeType === Node.ELEMENT_NODE) {
                    ...
                    while (c.nodeType !== Node.TEXT_NODE)
                        c = c.firstChild;
            ...
            while (d.commonAncestor.nodeType !== Node.ELEMENT_NODE)
        ...
        return b.prototype.normalize = function(a) {
            ...
            return g = function(d, e) {
                ...
                for (m = 0, n = h.length; m < n; m++)
                    g = h[m], i += g.nodeValue.length;
                return e ? [l, i + d.nodeValue.length] : [l, i]
            }, h = g(this.start), d = g(this.end, !0), new e.SerializedRange({start: h[0],end: d[0],startOffset: h[1],endOffset: d[1]})
        ...
        return b.prototype.normalize = function(b) {
            ...
            for (l = 0, n = p.length; l < n; l++) {
                ...
                if (!h)
                    throw new e.RangeError(i, "Couldn't find " + i + " node: " + this[i]);
                ...
                if (j[i + "Offset"] == null)
                    throw new e.RangeError("" + i + "offset", "Couldn't find offset " + this[i + "Offset"] + " in element " + this[i])
            }
            return c = document.compareDocumentPosition == null ? function(a, b) {
                ...
                if (c(this, j.endContainer))
                    return j.commonAncestorContainer = this, !1
        ...
        return H(c, b), c.prototype.events = {".annotator-adder button click": "onAdderClick",".annotator-adder button mousedown": "onAdderMousedown",".annotator-hl mouseover": "onHighlightMouseover",".annotator-hl mouseout": "startViewerHideTimer"}, c.prototype.html = {adder: '<div class="annotator-adder"><button>' + E("Annotate") + "</button></div>",wrapper: '<div class="annotator-wrapper"></div>'}, c.prototype.options = {readOnly: !1}, c.prototype.plugins = {}, c.prototype.editor = null, c.prototype.viewer = null, c.prototype.selectedRanges = null, c.prototype.mouseIsDown = !1, c.prototype.ignoreMouseup = !1, c.prototype.viewerHideTimer = null, c.prototype._setupWrapper = function() {
            ...
            var b = this;
            return this.viewer = new c.Viewer({readOnly: this.options.readOnly}), this.viewer.hide().on("edit", this.onEditAnnotation).on("delete", this.onDeleteAnnotation).addField({load: function(c, d) {
                    return d.text ? a(c).html(f.escape(d.text)) : a(c).html("<i>" + E("No Comment") + "</i>"), b.publish("annotationViewerTextField", [c, d])
                }}).element.appendTo(this.wrapper).bind({mouseover: this.clearViewerHideTimer,mouseout: this.startViewerHideTimer}), this
        }, c.prototype._setupEditor = function() {
            return this.editor = new c.Editor, this.editor.hide().on("hide", this.onEditorHide).on("save", this.onEditorSubmit).addField({type: "textarea",label: E("Comments") + "…",load: function(b, c) {
            ...
            return a(document).bind({mouseup: this.checkForEndSelection,mousedown: this.checkForStartSelection}), this
            ...
            for (j = 0, l = f.length; j < l; j++)
                d = f[j], b.quote.push(a.trim(d.text())), b.ranges.push(d.serialize(this.wrapper[0], ".annotator-hl")), a.merge(b.highlights, this.highlightRange(d));
            ...
            for (g = 0, h = i.length; g < h; g++)
                e = i[g], f.test(e.nodeValue) || j.push(a(e).wrapAll(d).parent().show()[0]);
            return j
        }, c.prototype.highlightRanges = function(b, c) {
            var d, e, f, g;
            c == null && (c = "annotator-hl"), d = [];
            for (f = 0, g = b.length; f < g; f++)
                e = b[f], a.merge(d, this.highlightRange(e, c));
            return d
        ...
        return H(b, a), b.prototype.pluginInit = function() {
        }, b
    }(c), m = f.getGlobal(), ((A = m.document) != null ? A.evaluate : void 0) == null && a.getScript("http://assets.annotateit.org/vendor/xpath.min.js"), m.getSelection == null && a.getScript("http://assets.annotateit.org/vendor/ierange.min.js"), m.JSON == null && a.getScript("http://assets.annotateit.org/vendor/json2.min.js"), m.Node == null && (m.Node = {ELEMENT_NODE: 1,ATTRIBUTE_NODE: 2,TEXT_NODE: 3,CDATA_SECTION_NODE: 4,ENTITY_REFERENCE_NODE: 5,ENTITY_NODE: 6,PROCESSING_INSTRUCTION_NODE: 7,COMMENT_NODE: 8,DOCUMENT_NODE: 9,DOCUMENT_TYPE_NODE: 10,DOCUMENT_FRAGMENT_NODE: 11,NOTATION_NODE: 12}), b.$ = a, b.Delegator = c, b.Range = e, b.Util = f, b._t = E, b.supported = function() {
        return function() {
        ...
        return H(d, c), d.prototype.classes = {hide: "annotator-hide",invert: {x: "annotator-invert-x",y: "annotator-invert-y"}}, d.prototype.checkOrientation = function() {
            var c, d, e, f, g;
            return this.resetOrientation(), g = a(b.Util.getGlobal()), f = this.element.children(":first"), d = f.offset(), e = {top: g.scrollTop(),right: g.width() + g.scrollLeft()}, c = {top: d.top,right: d.left + f.width()}, c.top - e.top < 0 && this.invertY(), c.right - e.right > 0 && this.invertX(), this
        ...
        return H(d, c), d.prototype.events = {"form submit": "submit",".annotator-save click": "submit",".annotator-cancel click": "hide",".annotator-cancel mouseover": "onCancelButtonMouseover","textarea keydown": "processKeypress"}, d.prototype.classes = {hide: "annotator-hide",focus: "annotator-focus"}, d.prototype.html = '<div class="annotator-outer annotator-editor">\n  <form class="annotator-widget">\n    <ul class="annotator-listing"></ul>\n    <div class="annotator-controls">\n      <a href="#cancel" class="annotator-cancel">' + E("Cancel") + '</a>\n<a href="#save" class="annotator-save annotator-focus">' + E("Save") + "</a>\n    </div>\n  </form>\n</div>", d.prototype.options = {}, d.prototype.show = function(a) {
            ...
            return d.append(f), f.attr({id: e.id,placeholder: e.label}), e.type === "checkbox" && (f[0].type = "checkbox", d.addClass("annotator-checkbox"), d.append(a("<label />", {"for": e.id,html: e.label}))), this.element.find("ul:first").append(d), this.fields.push(e), e.element
        ...
        return H(e, c), e.prototype.events = {".annotator-edit click": "onEditClick",".annotator-delete click": "onDeleteClick"}, e.prototype.classes = {hide: "annotator-hide",showControls: "annotator-visible"}, e.prototype.html = {element: '<div class="annotator-outer annotator-viewer">\n  <ul class="annotator-widget annotator-listing"></ul>\n</div>',item: '<li class="annotator-annotation annotator-item">\n  <span class="annotator-controls">\n    <a href="#" title="View as webpage" class="annotator-link">View as webpage</a>\n    <button title="Edit" class="annotator-edit">Edit</button>\n    <button title="Delete" class="annotator-delete">Delete</button>\n  </span>\n</li>'}, e.prototype.options = {readOnly: !1}, e.prototype.show = function(a) {
            var c, d = this;
            ...
            for (o = 0, q = s.length; o < q; o++) {
                c = s[o], k = a(this.item).clone().appendTo(n).data("annotation", c), f = k.find(".annotator-controls"), l = f.find(".annotator-link"), h = f.find(".annotator-edit"), g = f.find(".annotator-delete"), m = (new d(c.links || [])).get("alternate", {type: "text/html"}), m.length === 0 || m[0].href == null ? l.remove() : l.attr("href", m[0].href), this.options.readOnly ? (h.remove(), g.remove()) : e = {showEdit: function() {
                ...
                for (p = 0, r = t.length; p < r; p++)
                    j = t[p], i = a(j.element).clone().appendTo(k)[0], j.load(i, c, e)
            }
            return this.publish("load", [this.annotations]), this.show()
        }, e.prototype.addField = function(b) {
            var c;
            return c = a.extend({load: function() {
        ...
        return b.prototype.get = function(b, c) {
            ...
            c == null && (c = {}), c = a.extend({}, c, {rel: b}), f = function() {
                var a;
                a = [];
                for (e in c) {
                    if (!G.call(c, e))
        ...
        return H(d, c), d.prototype.events = {click: "hide"}, d.prototype.options = {html: "<div class='annotator-notice'></div>",classes: {show: "annotator-notice-show",info: "annotator-notice-info",success: "annotator-notice-success",error: "annotator-notice-error"}}, d.prototype.show = function(c, d) {
        ...
        return H(d, c), d.prototype.options = {message: b._t("Sorry your current browser does not support the Annotator")}, d.prototype.pluginInit = function() {
            var c = this;
            if (!b.supported())
                return a(function() {
                    b.showNotification(c.options.message);
                    if (window.XMLHttpRequest === void 0 && ActiveXObject !== void 0)
                        return a("html").addClass("ie6")
                })
        }, d
        ...
        a += "";
        while (j < a.length)
            f = c.indexOf(a.charAt(j++)), g = c.indexOf(a.charAt(j++)), h = c.indexOf(a.charAt(j++)), i = c.indexOf
            (a.charAt(j++)), d = f << 18 | g << 12 | h << 6 | i, k = d >> 16 & 255, l = d >> 8 & 255, m = d & 255, h === 64 ? n[b++] = String.fromCharCode(k) : i === 64 ? n[b++] = String.fromCharCode(k, l) : n[b++] = String.fromCharCode(k, l, m);
        return n.join("")
    }, h = function(a) {
        var b, c, d, e;
        c = a.length % 4;
        if (c !== 0)
            for (b = d = 0, e = 4 - c; 0 <= e ? d < e : d > e; b = 0 <= e ? ++d : --d)
                a += "=";
        ...
        return H(d, c), d.prototype.options = {token: null,tokenUrl: "/auth/token",autoFetch: !0}, d.prototype.requestToken = function() {
            var c = this;
            return this.requestInProgress = !0, a.ajax({url: this.options.tokenUrl,dataType: "text",xhrFields: {withCredentials: !0}}).done(function(a, b, d) {
                return c.setToken(a)
            }).fail(function(a, c, d) {
                var e;
            ...
            if (this.haveValidToken()) {
                ...
                while (this.waitingForToken.length > 0)
                    c.push(this.waitingForToken.pop()(this._unsafeToken));
                return c
            }
            console.warn(b._t("Didn't get a valid token."));
            if (this.options.autoFetch)
                return console.warn(b._t("Getting a new token in 10s.")), setTimeout(function() {
                    return d.requestToken()
                }, 1e4)
            ...
            var b;
            return b = this.element.data("annotator:headers"), this.element.data("annotator:headers", a.extend(b, {"x-annotator-auth-token": this.token}))
        }, d.prototype.withToken = function(a) {
            if (a == null)
                return;
            if (this.haveValidToken())
                return a(this._unsafeToken);
        ...
        return H(d, c), d.prototype.events = {annotationCreated: "annotationCreated",annotationDeleted: "annotationDeleted",annotationUpdated: "annotationUpdated"}, d.prototype.options = {annotationData: {},emulateHTTP: !1,loadFromSearch: !1,prefix: "/store",urls: {create: "/annotations",read: "/annotations/:id",update: "/annotations/:id",destroy: "/annotations/:id",search: "/search"}}, d.prototype.pluginInit = function() {
            ...
            var b = this;
            if (J.call(this.annotations, a) >= 0)
                return this._apiRequest("update", a, function(c) {
                    return b.updateAnnotation(a, c)
                })
        }, d.prototype.annotationDeleted = function(a) {
            var b = this;
            if (J.call(this.annotations, a) >= 0)
                return this._apiRequest("destroy", a, function() {
            ...
            for (g = 0, i = a.length; g < i; g++)
                b = a[g], d[b.id] ? (c = d[b.id], this.updateAnnotation(c, b)) : e.push(b);
            ...
            for (b = 0, c = d.length; b < c; b++)
                a = d[b], e.push(JSON.parse(this._dataFor(a)));
            return e
            ...
            var b;
            return b = {create: "POST",read: "GET",update: "PUT",destroy: "DELETE",search: "GET"}, b[a]
        ...
        return H(d, c), d.prototype.events = {beforeAnnotationCreated: "addFieldsToAnnotation"}, d.prototype.options = {showViewPermissionsCheckbox: !0,showEditPermissionsCheckbox: !0,userId: function(a) {
                return a
            ...
            },user: "",permissions: {read: [],update: [],"delete": [],admin: []}}, d.prototype.pluginInit = function() {
            var a, c, d = this;
            if (!b.supported())
                return;
        ...
        return H(c, b), c.prototype.options = {showViewPermissionsCheckbox: !0,showEditPermissionsCheckbox: !0,groups: {world: "group:__world__",authenticated: "group:__authenticated__",consumer: "group:__consumer__"},userId: function(a) {
                return a.userId
            },userString: function(a) {
                return a.userId
            },userAuthorize: function(a, b, c) {
            ...
            },permissions: {read: ["group:__world__"],update: [],"delete": [],admin: []}}, c.prototype.addFieldsToAnnotation = function(a) {
            if (a) {
                a.permissions = this.options.permissions;
                if (this.user)
                    return a.user = this.user.userId, a.consumer = this.user.consumerKey
            }
        }, c.prototype.updatePermissionsField = function(b, c, d) {
            var e;
            return c = a(c).show(), e = c.find("input").removeAttr("disabled"), this.authorize("admin", d) || c.hide(), this.user && this.authorize(b, d || {}, {userId: "__nonexistentuser__",consumerKey: this.user.consumerKey}) ? e.attr("checked", "checked") : e.removeAttr("checked")
        ...
        return H(d, c), d.prototype.events = {".annotator-filter-property input focus": "_onFilterFocus",".annotator-filter-property input blur": "_onFilterBlur",".annotator-filter-property input keyup": "_onFilterKeyup",".annotator-filter-previous click": "_onPreviousClick",".annotator-filter-next click": "_onNextClick",".annotator-filter-clear click": "_onClearClick"}, d.prototype.classes = {active: "annotator-filter-active",hl: {hide: "annotator-hl-filtered",active: "annotator-hl-active"}}, d.prototype.html = {element: '<div class="annotator-filter">\n  <strong>' + b._t("Navigate:") + '</strong>\n<span class="annotator-filter-navigation">\n  <button class="annotator-filter-previous">' + b._t("Previous") + '</button>\n<button class="annotator-filter-next">' + b._t("Next") + "</button>\n</span>\n<strong>" + b._t("Filter by:") + "</strong>\n</div>",filter: '<span class="annotator-filter-property">\n  <label></label>\n  <input/>\n  <button class="annotator-filter-clear">' + b._t("Clear") + "</button>\n</span>"}, d.prototype.options = {appendTo: "body",filters: [],addAnnotationFilter: !0,isFiltered: function(a, b) {
            ...
            for (c = 0, d = b.length; c < d; c++)
                a = b[c], this.annotator.subscribe(a, this.updateHighlights);
            return this
        }, d.prototype.addFilter = function(c) {
            var d, e;
            e = a.extend({label: "",property: "",isFiltered: this.options.isFiltered}, c);
            if (!function() {
                var a, b, c, f;
                c = this.filters, f = [];
                for (a = 0, b = c.length; a < b; a++)
                    d = c[a], d.property === e.property && f.push(d);
                return f
            }.call(this).length)
                e.id = "annotator-filter-" + e.property, e.annotations = [], e.element = this.filter.clone().appendTo(this.element), e.element.find("label").html(e.label).attr("for", e.id), e.element.find("input").attr({id: e.id,placeholder: b._t("Filter by ") + e.label + "…"}), e.element.find("button").hide(), e.element.data("filter", e), this.filters.push(e);
            return this
            ...
            if (e) {
                ...
                for (g = 0, h = i.length; g < h; g++)
                    c = i[g], f = c[b.property], b.isFiltered(e, f) && b.annotations.push(c);
            ...
            for (g = i = 0, j = e.length; i < j; g = ++i)
                c = e[g], f = f.not(c.highlights);
            ...
            var c;
            if (!b.target.value)
                return c = a(b.target), c.parent().removeClass(this.classes.active), c.next("button").hide()
        }, d.prototype._onFilterKeyup = function(b) {
            var c;
            c = a(b.target).parent().data("filter");
            if (c)
                return this.updateFilter(c)
            ...
            return b = a(b), this.highlights.removeClass(this.classes.hl.active), b.addClass(this.classes.hl.active), a("html, body").animate({scrollTop: b.offset().top - (this.element.height() + 20)}, 150)
        ...
        return H(d, c), d.prototype.events = {annotationViewerTextField: "updateTextField"}, d.prototype.updateTextField = function(c, d) {
            var e;
        ...
        return H(d, c), d.prototype.options = {parseTags: function(b) {
                var c;
            ...
            if (!b.supported())
                return;
            return this.field = this.annotator.editor.addField({label: b._t("Add some tags here") + "…",load: this.updateField,submit: this.setAnnotationTags}), this.annotator.viewer.addField({load: this.updateViewer}), this.annotator.plugins.Filter && this.annotator.plugins.Filter.addFilter({label: b._t("Tag"),property: "tags",isFiltered: b.Plugin.Tags.filterCallback}), this.input = a(this.field).find(":input")
        ...
        for (k = 0, l = h.length; k < l; k++)
            e = h[k], e in g && !g[e] ? m.push(void 0) : m.push(this.addPlugin(e, g[e]));
        return m
    }
})).call(this);
