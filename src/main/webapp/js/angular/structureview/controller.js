...
function CanvasCtrl($rootScope, $location, structureSrv) {
	...
	vm.showProgressClick = showProgressClick;
	vm.showDevelopersClick = showDevelopersClick;
	vm.showStoryPointsClick = showStoryPointsClick;

	vm.jiraNavClick = jiraNavClick;
	vm.cfNavClick = cfNavClick;
	...
	function showProgressClick() {
		vm.showIssueProgress = !vm.showIssueProgress;
		network.redraw();
	}

	function showDevelopersClick() {
		vm.showDevelopers = !vm.showDevelopers;
		network.redraw();
	}

	function showStoryPointsClick() {
		vm.showStoryPoints = !vm.showStoryPoints;
		network.redraw();
	}
    ...
    function click(node, clickFromCanvas) {
		...
		if (node.data.type.toLowerCase() == "requirement" || node.data.type.toLowerCase() == "design" ||
			...
			node.data.type.toLowerCase() == "new feature" ||
