    ...
    return function t(n, e, i) {
        ...
        2: [function (t, n) {
            ...
            i.prototype.head = function () {
                ...
                } else if (i > n)for (; (e = e.prev) && t !== e.point;); else for (; (e = e.next) && t !== e.point;);
        ...
        6: [function (t, n, e) {
            (function (n) {
                ...
                var o = t("./sweep");
                e.triangulate = o.triangulate, e.sweep = {Triangulate: o.triangulate}
        ...
        7: [function (t, n, e) {
            ...
            function a(t, n, e, i, o) {
                if (!h(i, n, e)) {
                    ...
                    if (s === M.COLLINEAR)throw new D("poly2tri EdgeEvent: Collinear not supported!", [e, r, n]);
                    var p = i.pointCW(o), u = z(e, p, n);
                    if (u === M.COLLINEAR)throw new D("poly2tri EdgeEvent: Collinear not supported!", [e, p, n]);
            ...
            function q(t, n, e, i, o) {
                ...
                if (i.getConstrainedEdgeAcross(o)) {
                    var p = i.index(o);
                    throw new D("poly2tri Intersecting Constraints", [o, s, i.getPoint((p + 1) % 3), i.getPoint((p + 2) % 3)])
                }
                if (H(o, i.pointCCW(o), i.pointCW(o), s))if (_(i, o, r, s), t.mapTriangleToNodes(i), t.mapTriangleToNodes(r), o === e && s === n)e === t.edge_event.constrained_edge.q && n === t.edge_event.constrained_edge.p && (i.markConstrainedEdgeByPoints(n, e), r.markConstrainedEdgeByPoints(n, e), l(t, i), l(t, r)); else {
                    var h = z(e, s, n);
            ...
            function k(t, n, e, i) {
                ...
                throw new D("poly2tri [Unsupported] nextFlipPoint: opposing point on constrained edge!", [n, i, t])
            }
            ...
            function A(t, n, e, i, o, r) {
                ...
                if (H(e, i.pointCCW(e), i.pointCW(e), p))q(t, e, p, s, p); else {
                    var a = k(n, e, s, p);
                    A(t, n, e, i, s, a)
                }
            }
            ...
            e.triangulate = i
        }, {"./advancingfront": 2, "./assert": 3, "./pointerror": 5, "./triangle": 9, "./utils": 10}],
        8: [function (t, n) {
            "use strict";
            var e = t("./pointerror"), i = t("./point"), o = t("./triangle"), r = t("./sweep"), s = t("./advancingfront"), p = s.Node, a = .3, h = function (t, n) {
                if (this.p = t, this.q = n, t.y > n.y)this.q = t, this.p = n; else if (t.y === n.y)if (t.x > n.x)this.q = t, this.p = n; else if (t.x === n.x)throw new e("poly2tri Invalid Edge constructor: repeated points!", [t]);
            ...
            g.prototype.addHole = function (t) {
            ...
            }, g.prototype.mapTriangleToNodes = function (t) {
                ...
                for (var n, e, i = [t]; n = i.pop();)if (!n.isInterior())for (n.setInterior(!0), this.triangles_.push(n), e = 0; 3 > e; e++)n.constrained_edge[e] || i.push(n.getNeighbor(e))
            }, n.exports = g
        }, {"./advancingfront": 2, "./point": 4, "./pointerror": 5, "./sweep": 7, "./triangle": 9}],
        9: [function (t, n) {
            "use strict";
            ...
            i.prototype.toString = function () {
                ...
                var e = this.points_;
                if (t === e[0])e[1] = e[0], e[0] = e[2], e[2] = n; else if (t === e[1])e[2] = e[1], e[1] = e[0], e[0] = n; else {
        ...
        11: [function (t, n) {
            ...
            n.exports = {toString: i, toStringBase: e, compare: o, equals: r}
        }, {}]
    }, {}, [6])(6)
});