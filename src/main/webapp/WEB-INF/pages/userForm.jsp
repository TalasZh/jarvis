...
<div class="col-sm-7">
    <s:form name="userForm" action="saveUser" method="post" validate="true" cssClass="well" autocomplete="off">
        ...
        <s:textfield key="user.name" required="true" autofocus="true" cssClass="form-control"/>
            ...
            <c:otherwise>
                <div class="form-group">
                    ...
                    <div class="controls readonly">
                        <s:iterator value="user.roleList" displayName="displayName">
                            <s:property value="label"/><s:if test="!#displayName.last">,</s:if>
