        ...
        this.$get = ["$log", "$rootElement", "$rootScope", "$cacheFactory", "$q", function (n, o, t, a, c) {
            ...
            return x || (n = {}, n.error = e.noop, n.warn = e.noop, n.info = e.noop), O.getInstanceInjector = function () {
                ...
                _broadcast: u, _$log: n, _getFilesCache: function () {
                    ...
                    var r = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], o = this, t = c.defer();
                    ...
                    if (i.length > 0) {
                        var s = i.slice(), u = function d(e) {
                            z.push(e), S[e] = t.promise, o._loadDependencies(e, r).then(function () {
                                try {
                                    l = [], L(O, z, r)
                                } catch (e) {
                                    return o._$log.error(e.message), void t.reject(e)
                                }
                                i.length > 0 ? d(i.shift()) : t.resolve(s)
                            }, function (e) {
                                t.reject(e)
                            })
                        };
                ...
                }, _invokeQueue: j, _registerInvokeList: $, _register: L, _addToLoadList: h
            }
        ...
        return {
            restrict: "A", terminal: !0, priority: 1e3, compile: function (i, a) {
                ...
                return i.html(""), function (a, u, c) {
                    var l = t(c.ocLazyLoad);
                    a.$watch(function () {
                        return l(a) || c.ocLazyLoad
                    }, function (t) {
