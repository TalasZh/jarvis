...
import org.safehaus.exceptions.InvalidIssueKeyException;
...
public class IssueKeyParser
{
     ...
     */
    public static List<IssueKeyParser> parseIssueKeys( String input )
    {
        List<IssueKeyParser> issueKeys = Lists.newArrayList();
        Matcher matcher = ISSUE_PATTERN.matcher( input );
        while ( matcher.find() )
        {
            issueKeys.add( new IssueKeyParser( getMatchedProjectKey( matcher ), getMatchedIssueId( matcher ) ) );
        }
     ...
     */
    public IssueKeyParser( String issueKey ) throws InvalidIssueKeyException
    {
     ...
     */
    public IssueKeyParser( String projectKey, String issueId )
    {
    ...
    public boolean equals( Object o )
    {
        ...
        IssueKeyParser issueKey = ( IssueKeyParser ) o;
    ...
    /**
     * A regex pattern that matches on JIRA issue keys. The individual components of a valid match should be extracted
     * using the {@link #getMatchedProjectKey(java.util.regex.Matcher)} and {@link #getMatchedProjectKey(java.util
     * .regex.Matcher)}
     * methods.
     */
