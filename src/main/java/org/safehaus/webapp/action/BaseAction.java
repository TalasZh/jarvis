...
/**
 * Implementation of <strong>ActionSupport</strong> that contains convenience methods for subclasses.  For example,
 * getting the current user and saving messages/errors. This class is intended to be a base class for all Action
 * classes.
 *
...
public class BaseAction extends ActionSupport
{
    ...
    private String securityCookieName = "crowd.token_key";
     ...
     *
     * @return the session from the request (request.getProject()).
     */
