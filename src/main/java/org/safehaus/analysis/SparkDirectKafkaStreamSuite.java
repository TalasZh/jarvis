...
public class SparkDirectKafkaStreamSuite implements Serializable {
    ...
    public static void startStreams(){
        ...
        JavaDStream<JiraMetricIssue> jiraIssuesDStream = jiraLogDStream.map(new Function<Tuple2<String, JiraMetricIssue>, JiraMetricIssue>() {
            public JiraMetricIssue call(Tuple2<String, JiraMetricIssue> tuple2) {
                return tuple2._2();
            }
        });

        JavaPairDStream<String, JiraMetricIssue> jiraAuthorIssuesDStream = jiraIssuesDStream.mapToPair(new PairFunction<JiraMetricIssue, String, JiraMetricIssue>() {
            public Tuple2<String, JiraMetricIssue> call(JiraMetricIssue jiraMetricIssue) throws Exception {
                return new Tuple2<String, JiraMetricIssue>(jiraMetricIssue.getAssigneeName(), jiraMetricIssue);
            }
        });

        JavaPairDStream<String, Integer> jiraAuthorIssueCountDStream = jiraAuthorIssuesDStream.mapToPair(new PairFunction<Tuple2<String, JiraMetricIssue>, String, Integer>() {
            public Tuple2<String, Integer> call(Tuple2<String, JiraMetricIssue> JiraMetricIssueTuple2) throws Exception {
        ...
        JavaPairDStream<String,JiraMetricIssue> jiraFinishedFilteredIssuesDStream = jiraAuthorIssuesDStream.filter(new Function<Tuple2<String, JiraMetricIssue>, Boolean>() {
        ...
        final Function2<List<Tuple4<Integer, Integer, Integer,Integer>>, Optional<Tuple4<Integer, Integer, Integer,Integer>>, Optional<Tuple4<Integer, Integer, Integer,Integer>>> updateProductivityMetricAndSaveDb =
                new Function2<List<Tuple4<Integer, Integer, Integer,Integer>>, Optional<Tuple4<Integer, Integer, Integer,Integer>>, Optional<Tuple4<Integer, Integer, Integer,Integer>>>() {
                    ...
                    public Optional<Tuple4<Integer, Integer, Integer,Integer>> call(List<Tuple4<Integer, Integer, Integer,Integer>> values, Optional<Tuple4<Integer, Integer, Integer,Integer>> state) {
                        Tuple4<Integer, Integer, Integer,Integer> newSum = state.or(new Tuple4<Integer, Integer, Integer, Integer>(0, 0, 0, 0));
        ...
        JavaPairDStream<Tuple3<String, Integer, Integer>, Tuple4<Integer, Integer, Integer,Integer>> jiraUserProductivityMetric =
                jiraFinishedFilteredIssuesDStream.mapToPair(new PairFunction<Tuple2<String, JiraMetricIssue>, Tuple3<String, Integer, Integer>,Tuple4<Integer, Integer, Integer,Integer>>() {
