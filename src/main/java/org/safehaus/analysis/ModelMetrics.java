...
public class ModelMetrics {
    ...
    public void getCaptureData(){
        JavaRDD<CaptureInternal> captureRDD = javaFunctions(jsc).cassandraTable(keyspace, table, mapRowTo(CaptureInternal.class));
    }
    ...
    public class CaptureInternal implements Serializable {
        ...
        public CaptureInternal(Long id, Date created, String annotationtext, String url, String ancestorid, String anchortext, String newcol)
        {
            this.id = id;
