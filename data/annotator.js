...
// Expose support vars for convenience
                        ...
                        setDocument = Sizzle.setDocument = function (node) {
                            ...
                            // #13936 IE6-8 do not support the defaultView property so parent will be undefined
                        ...
                        Expr = Sizzle.selectors = {
                            ...
                            pseudos: {
                                ...
                                "empty": function (elem) {
                                    ...
                                    // ref: 5), but not by others (comment: 8; processing instruction: 7; etc.)
                    ...
                    dispatch: function (event) {
                        ...
                        while ((matched = handlerQueue[i++]) && !event.isPropagationStopped()) {
                            ...
                            while ((handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped()) {
                                ...
                                // 2) have namespace(s) a subset or equal to those in the bound event (both can have no
                                // namespace).
                ...
                jQuery.removeEvent = document.removeEventListener ?
                    ...
                    function (elem, type, handle) {
                        ...
                        if (elem.detachEvent) {
                            ...
                            // detachEvent needed property on element, by name of that event, to properly expose it to
                            // GC
                    ...
                    domManip: function (args, callback) {
                        ...
                        if (l) {
                            ...
                            if (first) {
                                ...
                                // Use the original fragment for the last item instead of the first because it can end
                                // up being emptied incorrectly in certain situations (#8070).
                                for (; i < l; i++) {
                                    node = fragment;
                ...
                function actualDisplay(name, doc) {
                    ...
                    // getDefaultComputedStyle might be reliably used only on attached element
                        display = window.getDefaultComputedStyle && ( style = window.getDefaultComputedStyle(elem[0]) ) ?
                            ...
                            // Use of this method is a temporary fix (more like optmization) until something better
                            // comes along, since it was removed from specification and supported only in FF
                ...
                if (window.getComputedStyle) {
                    ...
                    curCSS = function (elem, name, computed) {
                        ...
                        if (computed) {
                            ...
                            // margin-right
                            // Safari 5.1.7 (at least) returns percentage for a larger set of values, but width seems
                            // to be reliably pixels this is against the CSSOM draft spec:
                ...
                if (!support.opacity) {
                    jQuery.cssHooks.opacity = {
                        ...
                        set: function (elem, value) {
                            ...
                            // #6652 if value === "", then remove inline opacity #12685
                            if (( value >= 1 || value === "" ) &&
                                ...
                                // if there is no filter style applied in a css rule or unset inline opacity, we are
                                // done
...
// http://blindsignals.com/index.php/2009/07/jquery-delay/
                ...
                (function () {
                    ...
                    // Test setAttribute on camelCase class. If it works, we need attrFixes when doing get/setAttribute
                    // (ie6/7)
...
// IE6/7 do not support getting/setting some attributes with get/setAttribute
                ...
                jQuery.extend({
                    ...
                    propHooks: {
                        tabIndex: {
                            get: function (elem) {
                                // elem.tabIndex doesn't always return the correct value when it hasn't been explicitly
                                // set
...
// Attach a bunch of functions for handling common AJAX events
                ...
                jQuery.offset = {
                    setOffset: function (elem, options, i) {
                        ...
                        // need to be able to calculate position if either top or left is auto and position is either
                        // absolute or fixed
                        ...
                        jQuery.fn[funcName] = function (margin, value) {
                            ...
                            return access(this, function (elem, type, value) {
                                ...
                                if (elem.nodeType === 9) {
                                    ...
                                    // whichever is greatest unfortunately, this causes bug #3838 in IE6/8 only, but
