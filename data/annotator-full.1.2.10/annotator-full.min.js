...
!function () {
    var $, Annotator,
        ...
        simpleXPathPure,
        _Annotator,
        _gettext, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _t, __slice = [].slice, __hasProp = {}.hasOwnProperty,
    ...
    Annotator = function (_super) {
        ...
        Annotator.prototype._disableDocumentEvents = function () {
    ...
    Annotator.Viewer = function (_super) {
        ...
        Viewer.prototype.html = {
            ...
            item: '<li class="annotator-annotation annotator-item">\n  <span class="annotator-controls">\n    <a href="#" title="View as webpage" class="annotator-link">View as webpage</a>\n    <button title="Edit" class="annotator-edit">Edit</button>\n    <button title="Delete" class="annotator-delete">Delete</button>\n  </span>\n <span class="annotator-session-indicator"><button></button></span>\n</li>'
        };
        ...
        Viewer.prototype.load = function (annotations) {
            var annotation, controller, controls, del, edit, sessionKey, element, field, item, link, links, list, _k, _l, _len2, _len3, _ref2, _ref3;
            ...
            for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                ...
                sessionKey = item.find(".annotator-session-indicator button");
                sessionKey.text(annotation.researchSession);
    ...
    Annotator.Plugin.Store = function (_super) {
        ...
        Store.prototype._makeUri = function (pathname) {
            const urlPath = this.options.hostURL + this.options.basePath + pathname;
        ...
        Store.prototype._doRequest = function (opts, callback, methodType) {
            if (opts.headers) {
            ...
            switch (methodType) {
                case "GET":
                    this.options.request(opts).get();
                    break;
                case "HEAD":
                    this.options.request(opts).head();
                    break;
                case "POST":
                    this.options.request(opts).post();
                    break;
                case "PUT":
                    this.options.request(opts).put();
                    break;
                case "DELETE":
                    this.options.request(opts).delete();
                    break;
                default:
        ...
        Store.prototype.setupResearchFields = function (annotation) {
            if (annotation) {
        ...
        Store.prototype._onLoadAnnotations = function (response) {
        ...
        Store.prototype._apiRequestOptions = function (action, obj, onSuccess) {
            ...
            opts = {
                ...
                dataType: "json",
                onComplete: onSuccess || function (response) {
                },
                error: this._onError
            };
        ...
        Store.prototype._onError = function (act, status) {
            var action, message;
            var response = {};
