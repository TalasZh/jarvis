...
((function () {
    ...
    Annotator.Plugin.Offline = Offline = function (a) {
        function Offline() {
            ...
            for (event in handlers) {
                ...
                if (typeof this.options[handler] === "function") {
                    console.log("Event: " + event + " proxied");
        ...
        return __extends(Offline, a),
            ...
            Offline.prototype.options = {
                getUniqueKey: function (annotation) {
                    return annotation.id || (annotation.id = Offline.uuid()), annotation.id
                },
        ...
        Annotator.Plugin.Offline.Store = Store = function (a) {
            ...
            return __extends(Store, a), Store.KEY_PREFIX = "annotator.offline/", Store.CACHE_DELIMITER = "--cache--", Store.localStorage = window.localStorage, Store.isSupported = function () {
                try {
