...
<div class="panel panel-default">
  <display:table name="spaces" cellspacing="0" cellpadding="0" requestURI="" export="true" id="space"
    ...
    <display:column property="description.plain.value" escapeXml="true" sortable="true"
                    titleKey="confluence.space.description" media="html"
                    style="width: 25%"/>
    <display:column property="type" escapeXml="true" sortable="true" titleKey="confluence.space.type"
                    style="width: 5%"/>
