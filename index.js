...
exports.main = function (options) {
    ...
    var floatingCtrl = pageMod.PageMod({
        ...
        // contentStyle: '@font-face{font-family: "Material-Design-Icons";src: url("'+
        // data.url("materialize/font/material-design-icons/Material-Design-Icons.woff") + '") format("woff");
