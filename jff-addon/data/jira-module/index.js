...
JiraApi.prototype.findIssue = function (issueNumber, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", Issue not found or you don't have permissions to view it.");
            return;
        }
        ...
        if (response.json === undefined) {
            callback(response.statusText + ", Response body was undefined");
            return;
        }
...
JiraApi.prototype.getUnresolvedIssueCount = function (version, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", Version doesn't exist or doesn't have\
...
JiraApi.prototype.getProject = function (project, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", Project doesn't exist or doesn't have permissions");
            return;
        }
        if (response.status !== 200) {
            callback(response.statusText + ": Unable to connect to \
...
JiraApi.prototype.issueLink = function (link, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 400) {
            callback(response.statusText + ", can't create the supplied comment: " + response.text);
            return;
        }
        if (response.status === 401) {
            callback(response.statusText + ", user does not have the link issue permission \
					 for the issue, which will be linked to another issue");
            return;
        }
        if (response.status === 404) {
            callback(response.statusText + ", issue linking is disabled or it failed to find one of \
        ...
        if (response.status === 500) {
            callback(response.statusText + ", an error occurred when creating the issue \
					 link or the comment");
            return;
        }
        if (response.status !== 200) {
...
JiraApi.prototype.getRemoteLinks = function (issueNumber, callback) {
    ...
    this.doRequest(options, function (response) {
        ...
        if (response.status === 401) {
            callback(response.statusText + ", calling user is not authenticated");
            return;
        }
        if (response.status === 403) {
            callback(response.statusText + ", calling user does not have permission to view \
					 the remote issue links, or if issue linking is disabled.");
            return;
        }
        if (response.status === 404) {
            callback(response.statusText + ", the issue or remote issue link do not exist.");
            return;
        }
        if (response.status !== 200) {
...
JiraApi.prototype.createRemoteLink = function (issueNumber, remoteLink,
    ...
    this.doRequest(options, function (response) {
        ...
        if (response.status === 403) {
            callback(response.statusText + ", calling user does not have permission to \
...
JiraApi.prototype.getVersions = function (project, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", Project not found or no permissions to view it");
            return;
        }
        if (response.status !== 200) {
...
JiraApi.prototype.createVersion = function (version, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 403) {
            callback(response.statusText + ", Currently authenticated user does not have \
					 permission to edit the version.");
            return;
        }
        if (response.status === 404) {
            callback(response.statusText + ", Version does not exist or the currently authenticated \
...
JiraApi.prototype.updateVersion = function (version, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", the version does not exist or the currently \
...
JiraApi.prototype.searchJira = function (searchString, optional, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 400) {
            callback(response.statusText + ", there is a problem with the JQL query");
            return;
        }
...
JiraApi.prototype.searchUsers = function (username, startAt,
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", the requested user is not found");
            return;
        }
        if (response.status === 401) {
            callback(response.statusText + ", the current user is not authenticated");
            return;
        }
        if (response.status !== 200) {
...
JiraApi.prototype.addNewIssue = function (issue, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 400) {
            callback(response.statusText + ", error occurred adding new issue" + response.text);
            return;
        }
...
JiraApi.prototype.updateIssue = function (issueNumber, issueUpdate, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 400) {
            callback(response.statusText + ", requested issue update failed");
            return;
        }
...
JiraApi.prototype.listComponents = function (project, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", project is not found, or the calling user does \
...
JiraApi.prototype.listTransitions = function (issueId, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + "requested issue is not found or the user does not have \
...
JiraApi.prototype.transitionIssue = function (issueId, issueTransition, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 404) {
            callback(response.statusText + ", The issue does not exist or the user does not have permission to view it");
            return;
        }
        if (response.status === 400) {
            callback(response.statusText + ", there is no transition specified");
            return;
        }
        if (response.status !== 204) {
...
JiraApi.prototype.listProjects = function (callback) {
    ...
    this.doRequest(options, function (response) {
        ...
        if (response.status === 500) {
            callback(response.statusText + ", error while retrieving the list of projects");
            return;
        }
        if (response.status !== 200) {
...
JiraApi.prototype.addComment = function (issueId, comment, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 400) {
            callback(response.statusText + ", the input is invalid");
            return;
        }
        if (response.status !== 201) {
...
JiraApi.prototype.addWorklog = function (issueId, worklog,
    ...
    this.doRequest(options, function (response) {
        if (response.status === 403) {
            callback(response.statusText + ", user does not have permission to add the worklog");
            return;
        }
        if (response.status === 400) {
            callback(response.statusText + ", the input is invalid");
...
JiraApi.prototype.getCurrentUser = function (callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 401) {
            callback(response.statusText + ", caller is not authenticated");
            return;
        }
        if (response.status !== 200) {
...
JiraApi.prototype.startSession = function (credentials, callback) {
    ...
    this.doRequest(options, function (response) {
        if (response.status === 403) {
            callback(response.statusText + ", login is denied due to a CAPTCHA requirement, \
        ...
        if (response.status === 401) {
            callback(response.statusText + ", login fails due to invalid credentials");
            return;
        }
        if (response.status !== 200) {
